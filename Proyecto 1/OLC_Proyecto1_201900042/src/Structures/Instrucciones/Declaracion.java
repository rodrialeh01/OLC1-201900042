    ...
    public String traductorGolang(int identacion) {
        ...
        for (int i = 0; i < this.listaidentificadores.size(); i++) {
            if(tipo== Parametro.Tipo_Variable.NUMERO){
                if(valor != null){
                    declaraciones+=OLC_Proyecto1_201900042.tabular(identacion) + "var "+ this.listaidentificadores.get(i).traductorGolang(identacion) + " = " + valor.traductorGolang(identacion) + "\n";
                }
